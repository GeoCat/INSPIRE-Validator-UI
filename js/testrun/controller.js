		...
		return function(item) {
			...
			if (($scope.searchParameters.searchedTerm.length == 0) && ($scope.searchParameters.resourceType == 'any') && ($scope.searchParameters.status == 'any')) {
				...
				if ($scope.searchParameters.resourceType != 'any') {
					...
					if ($scope.searchParameters.resourceType == "metadata") var arrayTestSuiteId = ["EID59692c11-df86-49ad-be7f-94a1e1ddd8da", "EIDe4a95862-9cc9-436b-9fdd-a0115d342350", "EID2be1480a-fe42-40b2-9420-eb0e69385c80", "EID59692c11-df86-49ad-be7f-94a1e1ddd8da", "EID8f869e23-c9e9-4e86-8dca-be30ff421229", "EID606587df-65a8-4b7b-9eee-e0d94daaa42a", "EID59692c11-df86-49ad-be7f-94a1e1ddd8da", "EID8f869e23-c9e9-4e86-8dca-be30ff421229", "EID8db54d8a-8578-4959-b891-5394d9f53a28", "EID7514777a-6cb8-499c-acd5-912496dc84e9", "EIDa593a7ad-42d9-46d0-985d-9dff3e684428"];					if ($scope.searchParameters.resourceType == "viewservice") var arrayTestSuiteId = ["EIDeec9d674-d94b-4d8d-b744-1309c6cae1d2", "EID550ceacf-b3cb-47a0-b2dd-d3edb18344a9"];
